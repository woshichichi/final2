...
//    @Cacheable(value = "username",key = "targetClass + methodName")
...
//            stringRedisTemplate.opsForValue().set(Constants.USER_KEY, JSONUtil.toJsonStr(user1), 30L, TimeUnit.MINUTES);
//            System.out.println("pp");
//        } else {
//            System.out.println("oo");
//            user1 = JSONUtil.toBean(jsonStr, new TypeReference<User>() {
//            }, true);
//        }
...
//    }
    ...
    @GetMapping("/uu")
    public Result doingb(){
        User user2;
        String jsonStr = stringRedisTemplate.opsForValue().get(Constants.USER_KEY);
        user2 = JSONUtil.toBean(jsonStr, new TypeReference<User>() {
           }, true);
